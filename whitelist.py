...
SECRET_KEY  # unused variable (config.py:12)
ACCOUNT_SERVICE_URL  # unused variable (config.py:15)
LANGUAGES  # unused variable (config.py:16)
EQ_URL  # unused variable (config.py:17)
...
DEBUG  # unused variable (config.py:35)
...
TestingConfig  # unused class (config.py:34)
